...
public class AMOEBA_UI {
	...
	public AMOEBA_UI(boolean viewer, String percepts){
		...
		if(percepts.contentEquals("position")){
			amoeba = AMOEBAFactory.createAMOEBA(viewer,"experiments/droneControl/DroneControl_solver.xml");
		}
		else if (percepts.contentEquals("speed")){
			amoeba = AMOEBAFactory.createAMOEBA(viewer,"experiments/droneControl/DroneControlVariations_solver.xml");
		}
	}
