...
import view.system.PanelController;
import view.system.paving.Panel1DPaving;
import view.system.projection.PanelProjection;
import agents.Agent;
...
import graphView.GraphicVisualization2Dim;
import graphView.GraphicVisualizationNDim;
import graphView.TemporalGraph;
...
private void startPanelController() {
	...
	public void setStandardStyle() {
		...
		graph.addAttribute("ui.stylesheet", "url('" + this.getClass().getClassLoader().getResource("src/styles/styleSystemScalable.css") + "')");
	}
