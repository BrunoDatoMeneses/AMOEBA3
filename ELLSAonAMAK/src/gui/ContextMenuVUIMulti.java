...
public class ContextMenuVUIMulti extends ContextMenu {
	 ...
	 */
	public ContextMenuVUIMulti(ELLSA ellsa, VUIMulti vui) {
	...
	private void setupRequestHereMenuItem(ELLSA ellsa, VUIMulti vui) {
	 ...
	 * @param vui
	 */
	private void reqTwoDimension(ELLSA ellsa, VUIMulti vui) {
	 ...
	 * @param vui
	 */
	private void reqNDimension(ELLSA ellsa, VUIMulti vui) {
		double x = vui.screenToWorldX(reqHereX);
		double y = vui.screenToWorldY(reqHereY);
	...
	private void setupLearnHereMenuItem(ELLSA ellsa, VUIMulti vui) {
	 ...
	 * @param vui
	 */
	private void learnTwoDimension(ELLSA ellsa, VUIMulti vui) {
		double x = vui.screenToWorldX(reqHereX);
		double y = vui.screenToWorldY(reqHereY);
		HashMap<String, Double> req = new HashMap<String, Double>();
		req.put(ellsa.getDimensionSelector().d1().getName(), x);
	 ...
	 * @param vui
	 */
	private void learnNDimebsion(ELLSA ellsa, VUIMulti vui) {
		double x = vui.screenToWorldX(reqHereX);
		double y = vui.screenToWorldY(reqHereY);
