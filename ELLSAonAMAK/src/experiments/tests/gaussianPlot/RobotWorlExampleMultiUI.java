...
public class RobotWorlExampleMultiUI extends Amas<WorldExampleMultiUI> {
	...
	public RobotWorlExampleMultiUI(AmasMultiUIWindow window, VUIMulti vui, WorldExampleMultiUI env) {
		...
		robotExampleMutliUI = new RobotExampleMutliUI(amasMultiUIWindow, this, 0, 0);
