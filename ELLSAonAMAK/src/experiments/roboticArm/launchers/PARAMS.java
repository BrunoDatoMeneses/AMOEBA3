...
public class PARAMS {
    ...
    /* FOR OTHER EXPERIMENTS, NOT RELATED TO THE ARTICLE */
    ...
    public static  int nbOfNeighborForContexCreationWithouOracle = 10000;
    public static  int nbOfNeighborForVoidDetectionInSelfLearning = 50000;
